...
//  node list-tree-dir-2niv C:\Users\frede\Music\ music.html
//  node list-tree-dir-2niv C:\Users\frede\Music\ music.txt
...
function buildHtml(tree, title) {
  ...
  for (const level1 of tree) {
    ...
    if (level1.children.length > 0) {
      const rowValues = level1.children.map((child) => child.name);
